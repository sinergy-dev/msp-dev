          ...
          <div class="row">
            ...
            <table id="product-add">
              ...
              <tr>
                ...
                <td style="margin-bottom: 50px;">
                    <br>
                    <select class="form-control detail-product" name="detail_product[]" id="detail-product0" data-rowid="0" style="font-size: 14px" multiple="multiple" required>
