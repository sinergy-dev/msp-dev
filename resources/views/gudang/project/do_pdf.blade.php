            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: left;">
                        Phone   :    62-21- 583 57844<br>
                        E-mail  :    <a>info@solusindoperkasa.co.id</a>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table style="width: 100%; font-size: 6pt; border-collapse: collapse; border: 1px solid black;">
            <thead style="background-color: #e2e2e2">
                <tr>
                    ...
                    <th style="width: 15%; text-align: center">MSP Code</th>
            ...
            <tbody class="a">
                ...
                <tr>
                    ...
                    <td style="border : 1px solid black; padding-left:5px;">{{$produk->kode_barang}}</td>
                    <td style="border : 1px solid black; padding-left:5px;">{{$produk->nama}}</td>
                    <td style="text-align: center; border : 1px solid black;">{{$produk->qty_transac}}</td>
            ...
            <tbody>
                <tr style="text-align: center;">
                    <td style="width: 22%;">
                        ...
                        <u style="text-decoration: overline;">PT. Multi Solusindo Perkasa</u><!-- 
                    ...
                    <td style="width: 30%;">
                        <p>Receiver : </p><br><br><br><br><br><br>
                        <u style="text-decoration: overline;">{{$datas->to_agen}}</u><!-- 
