          ...
          <tbody id="products-list" name="products-list">
              @foreach($pam as $data)
                <tr>
                  ...
                  <td>{{$data->subject}}</td>
                  <td>
                  	<a href="{{url('/detail/do_sup',$data->id_po_asset)}}"><button class="btn btn-sm btn-success">Detail</button></a>
                  </td>
                  <td>
	              ...
	              @endif
                  <!-- <a href="" target="_blank"><button class="btn btn-md btn-info" style="width: 100%"><b><i class="fa fa-print"></i> Print to PDF </b></button></a>	 -->
                  </td>
                </tr>
              @endforeach
