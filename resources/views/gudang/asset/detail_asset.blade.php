...
<div class="content-wrapper">
    ...
    <div class="alert alert-success" id="alert">
      ...
      @endif
      <a href="{{url('/asset')}}"><button class="btn btn-sm btn-danger margin-bottom" style="width: 150px"><i class="fa fa-back"></i>&nbsp back to List Asset</button></a>
      <div class="card mb-3">
        <div class="card-header">
           <i class="fa fa-table"></i>&nbsp<b>Detail Peminjaman Product Table</b>
        </div>
        <div class="card-body">
