  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header">
        <h3 class="box-title"><i class="fa fa-table"></i>&nbspPartnership</h3>
      ...
      <div class="box-body">
        <div class="table-responsive">
            <table class="table table-bordered display nowrap table-striped dataTable" id="datastable" style="width: 100%" cellspacing="0">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Type</th>
