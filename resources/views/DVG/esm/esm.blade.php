  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header">
        <h3 class="box-title"><i class="fa fa-table"></i>&nbspClaim Management</h3>
      ...
      <div class="box-body">
        ...
        <div class="table-responsive" id="div_2019">
          <table class="table table-bordered table-striped dataTable display nowrap" id="data_all2019" width="100%" cellspacing="0">
            <thead>
              <tr>
                <th>No</th>
                <th>Date</th>
