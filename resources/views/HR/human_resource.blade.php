      ...
      <div class="box-body">
        ...
        <div class="nav-tabs-custom active" id="SIP" role="tabpanel" aria-labelledby="sip-tab">
          ...
          <div class="pull-right">
            ...
            <button class="btn btn-sm btn-primary pull-right" style="margin-top: 12px;width: 100px" id="btnAdd" data-toggle="modal" data-target="#modalAdd"><i class="fa fa-plus"></i>&nbsp Employee</button>
            @endif<hr class="new4">
          </div>
          ...
          <div class="tab-content" id="myTabContentSIP">
            <div class="tab-pane active" id="all" role="tabpanel" aria-labelledby="tech-tab">
                    ...
                    <table class="table table-bordered table-striped dataTable" id="data_all" width="100%" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          @if(Auth::User()->id_position == 'HR MANAGER' || Auth::User()->id_division == 'TECHNICAL' || Auth::User()->id_position == 'DIRECTOR')
                          <td>
                            <button class="btn btn-xs btn-primary" data-target="#modal_update" data-toggle="modal" style="vertical-align: top; width: 60px" onclick="update_HR('{{$data->nik}}','{{$data->name}}','{{$data->email}}','{{$data->date_of_entry}}','{{$data->date_of_birth}}','{{$data->address}}','{{$data->phone}}','{{$data->password}}')"><i class="fa fa-search"></i>&nbspEdit</button>
