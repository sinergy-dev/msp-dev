...
<section class="content">
  ...
  <div class="box">
    <div class="box-header">
      <h3 class="box-title"><i class="fa fa-table"></i>&nbspLetter</h3>
        <div class="pull-right">
          ...
          @endif
          <a href="{{url('/downloadExcelLetter')}}"><button class="btn btn-warning" style="height: 40px; margin-right: 10px;"><i class="fa fa-print"></i> EXCEL </button></a>
        </div>
    </div>
    <div class="box-body">
                  ...
                  <tbody id="products-list" name="products-list">
                   ...
                   <tr>
                      ...
                      <td>
                        ...
                        <button class="btn btn-xs btn-primary" style="vertical-align: top; width: 60px" data-target="#modaledit" data-toggle="modal" onclick="edit_po('{{$data->no}}','{{$data->type_of_letter}}','{{$data->to}}','{{$data->attention}}','{{$data->title}}','{{$data->project}}','{{$data->description}}', '{{$data->project_id}}', '{{$data->note}}')">&nbsp Edit
                        </button>
                        @else
                ...
                <table class="table table-bordered nowrap DataTable" id="data_backdate"  cellspacing="0">
                  ...
                  <tbody id="products-list" name="products-list">
                   ...
                   <tr>
                      ...
                      <td>
                        @if(Auth::User()->nik == $data->nik)
                        <button class="btn btn-xs btn-primary" data-target="#modaledit" data-toggle="modal" onclick="edit_po('{{$data->no}}','{{$data->type_of_letter}}','{{$data->to}}','{{$data->attention}}','{{$data->title}}','{{$data->project}}','{{$data->description}}', '{{$data->project_id}}','{{$data->note}}')">&nbsp Edit
                        </button>
                        @else
