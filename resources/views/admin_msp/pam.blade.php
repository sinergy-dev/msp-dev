...
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      @if(Auth::User()->id_position == 'PM' && Auth::User()->id_company == '2')
      <div class="pull-right">
        <a href="{{url('/add_pam')}}"><button class="btn btn-sm btn-success pull-right float-right margin-left-custom" id=""><i class="fa fa-plus"> </i>&nbsp PR Asset</button></a>
        ...
        <?php $no = 1; ?>
              ...
              @foreach($pam as $data)
                <tr>
                  ...
                  <td>
                    @if($sum >= 1)
                    <a href="{{url('add_produk_pam', $data->id_pam)}}"><button class="btn btn-success" style="width: 85px;height: 30px;text-align: center;"><i class="fa fa-plus"></i>&nbspProduct</button></a>
                    @endif
                  </td>
                  @else
                  <td>
                    <button class="btn btn-success disabled" style="width: 85px;height: 30px;text-align: center;"><i class="fa fa-plus"></i>&nbspProduct</button>
                  </td>
                  @endif
                  <td>
                  @if($data->status_po == 'PENDING' || $data->status_po == 'DONE' || $data->status == 'NEW' || $data->status == 'ADMIN')
                  <button class="btn btn-info btn-md disabled" style="color: white;width: 100%"><i class="fa fa-print"></i><b>Print to PDF</b></button>
                  @else
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Submit to Finance</h4>
        </div>
