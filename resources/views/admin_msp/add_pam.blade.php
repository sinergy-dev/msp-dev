...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      <form method="POST" action="{{url('store_pr_asset_msp')}}" id="modal_pr_asset" name="modal_pr_asset" enctype="multipart/form-data">
        @csrf
        <div class="row">
          <div class="col-sm-7">
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <textarea type="text" name="subject" id="subj" class="form-control" placeholder="Enter Subject" required></textarea>
              </div>
            </div> 
          ...
          <div class="col-sm-5">
            ...
            <div class="form-group row" style="margin-left: -12px">
              <label for="upload_file" class="col-sm-4 control-label">Upload File Quotation</label>
                 <div class="col-sm-8">
