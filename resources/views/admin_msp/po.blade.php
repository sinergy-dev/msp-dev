  ...
  <div class="box">
    <div class="box-header with-border">
      <div class="pull-right">
        <button type="button" class="btn btn-sm btn-success pull-right hidden" style="width: 200px" data-target="#modal_pr" data-toggle="modal"><i class="fa fa-plus"> </i>&nbsp Number Purchase Order</button>
        <!-- <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 30px, 0px);">
          <a class="dropdown-item disabled" href="{{url('/downloadPdfESM')}}"> PDF </a> -->
          <a href="{{url('/downloadExcelPOMSP')}}"><button class="btn btn-sm btn-warning" style="margin-right: 5px"> EXCEL</button> </a>
        <!-- </div> -->
      </div>
    </div>
        ...
        <table class="table table-bordered table-striped nowrap" id="data_Table" width="100%" cellspacing="0">
          ...
          <tbody id="products-list" name="products-list">
            ...
            <tr>
              ...
              <td>
                <button class="btn btn-sm btn-primary fa fa-pencil" data-target="#modaledit" data-toggle="modal" style="width: 30px;height: 30px;text-align: center;" onclick="edit_po('{{$data->no}}','{{$data->to}}','{{$data->attention}}','{{$data->title}}','{{$data->project}}','{{$data->description}}', '{{$data->from}}', '{{$data->issuance}}', '{{$data->project_id}}')">
                </button>
      ...
      <div class="modal-content modal-md">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control hidden" placeholder="Enter Project ID" name="edit_id_project" id="edit_id_project">
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal"><i class=" fa fa-times"></i>&nbspClose</button>
            <button type="submit" class="btn btn-primary"><i class="fa fa-check"> </i>&nbspSubmit</button>
