...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      <form method="POST" action="{{url('store_po_asset_msp')}}" id="modal_pr_asset" name="modal_pr_asset">
        @csrf
        <div class="row">
          ...
          <div class="col-sm-7">
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <input class="form-control" name="no_po" id="no_po" type="number" placeholder="Enter No PO">
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <input class="form-control" name="to_agen" id="to_agen" type="text" placeholder="Enter To" readonly>
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <input type="number" name="telp" id="telp" class="form-control" placeholder="Enter Telp.">
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <input type="text" name="att" id="att" class="form-control" placeholder="Enter Attention" readonly>
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <textarea type="text" name="subject" id="subj" class="form-control" placeholder="Enter Subject" readonly></textarea>
              </div>
            </div> 
          </div>
          ...
          <div class="col-sm-5">
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-8">
                <input class="form-control" id="today" name="create_date" type="date" >
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" placeholder="Enter Project" name="project" id="project" readonly>
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-8">
                ...
                <input type="text" class="form-control" placeholder="Enter Project" name="id_project" id="id_project" readonly>
              </div>
            </div>
          </div>
         ...
         $.ajax({
          ...
          success: function(result){
            $.each(result[0], function(key, value){
              $("#to_agen").val(value.to);
              $("#att").val(value.attention);
              $("#subj").val(value.subject);
