      ...
      <form method="POST" action="{{url('store_pr_msp')}}" id="modal_pr_asset" name="modal_pr_asset">
        ...
        <div class="row">
          ...
          <div class="col-sm-7">
            ...
            <input type="" value="eksternal" name="tipe_pr" hidden>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <input class="form-control" name="no_pr" id="no_pr" type="number" placeholder="Enter No PR">
              </div>
            </div>
          ...
          <div class="col-sm-5">
            ...
            <!-- <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-8">
                ...
                <input type="text" class="form-control" placeholder="Enter Project" name="project_id" id="project_id" >
              </div>
            </div> -->
          </div>
