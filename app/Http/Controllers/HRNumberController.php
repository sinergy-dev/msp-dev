...
class HRNumberController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin/hr_number', compact('lead', 'total_ter','notif','notifOpen','notifsd','notiftp','id_pro', 'datas', 'notifClaim','pops'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $getnumber = HRNumber::orderBy('no', 'desc')->first();
