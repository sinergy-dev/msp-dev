...
class HRController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('HR/human_resource', compact('hr','notif','notifOpen','notifsd','notiftp','ter','code', 'notifClaim'));
    }
    ...
    public function store(Request $request)
    {
        ...
        }/*else if ($request['territory_expert']!= '') {
    ...
    public function update_humanresource(Request $request)
    {
        ...
        if ($request['id_sub_division_tech_msp_update'] == 'NONE_MSP') {
            $update->id_division = NULL;
        }else{
    ...
    public function user_profile()
    {
        ...
        if ($div == 'SALES' && $ter != ''  || $div == 'TECHNICAL' && $ter == 'DVG' || $ter == 'DPG') {
            $user_profile = DB::table('users')
                        ...
                        ->select('users.name','tb_division.name_division','tb_position.name_position','users.email','users.date_of_birth','users.nik','users.phone','users.gambar','tb_territory.name_territory','users.date_of_entry','users.address')
                        ->where('users.nik',$nik)
                        ->first();
             ...
             $user_profile = DB::table('users')
                        ->join('tb_division','tb_division.id_division','=','users.id_division')
                        ->join('tb_position','tb_position.id_position','=','users.id_position')
                        ->select('users.name','tb_division.id_division','tb_position.name_position','users.email','users.date_of_birth','users.nik','users.phone','users.gambar','users.date_of_entry','users.address')
                        ->where('users.nik',$nik)
                        ->first();
             ...
             $user_profile = DB::table('users')
                        ->join('tb_division','tb_division.id_division','=','users.id_division')
                        ->join('tb_position','tb_position.id_position','=','users.id_position')
                        ->select('users.name','tb_division.name_division','tb_position.name_position','users.email','users.date_of_birth','users.nik','users.phone','users.gambar','users.date_of_entry','users.address')
                        ->where('users.nik',$nik)
                        ->first();
           ...
           $user_profile = DB::table('users')
                        ->join('tb_position','tb_position.id_position','=','users.id_position')
                        ->select('users.name','tb_position.name_position','users.email','users.date_of_birth','users.nik','users.phone','users.gambar','users.date_of_entry','users.address')
                        ->where('users.nik',$nik)
                        ->first();
        }
