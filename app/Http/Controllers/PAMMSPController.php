...
class PAMMSPController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($pos == 'PM') {
            $pam = DB::table('tb_pam_msp')
                ->join('users','users.nik','=','tb_pam_msp.nik_admin')
                ->join('tb_pr_msp','tb_pr_msp.no','=','tb_pam_msp.no_pr')
                ->join('tb_po_asset_msp', 'tb_po_asset_msp.id_pr_asset', '=', 'tb_pam_msp.id_pam')
                ->select('tb_pam_msp.id_pam','tb_pam_msp.date_handover','tb_pr_msp.no_pr','tb_pam_msp.to_agen','tb_pam_msp.status','users.name','tb_pam_msp.subject', 'tb_pr_msp.no', 'tb_pr_msp.date', 'tb_pam_msp.attention', 'tb_pam_msp.project', 'tb_pam_msp.project_id', 'ppn', 'terms', 'tb_po_asset_msp.id_po_asset', 'tb_po_asset_msp.id_pr_asset','status_po')
        ...
        $msp_code = Inventory_msp::select('kode_barang','id_product','nama')->get();


        return view('admin_msp/pam',compact('notif','notifOpen','notifsd','notiftp','notifClaim','pam','produks','pams','sum','id_pam','count_product','total_amount','no_pr','$total_amount','from', 'project_id', 'msp_code'));
    }
    ...
    public function add_pam(Request $request)
    {
        ...
        return view('/admin_msp/add_pam',compact('notif','notifOpen','notifsd','notiftp','notifClaim','from', 'project_id', 'msp_code'));
    }

    public function add_produk_pam($id_pam)
    {
        ...
        $datas = DB::table('tb_pam_msp')
        			->join('tb_pr_msp', 'tb_pr_msp.no', '=', 'tb_pam_msp.no_pr')
        			->select('id_pam', 'tb_pam_msp.subject', 'tb_pr_msp.no_pr')
        			->where('tb_pam_msp.id_pam', $id_pam)
        			->first();

        $msp_code = Inventory_msp::select('kode_barang','id_product','nama', 'unit')->get();
        
        return view('/admin_msp/add_produk_pam',compact('notif','notifOpen','notifsd','notiftp','notifClaim', 'msp_code', 'datas'));
    }
    ...
    public function detail_pam($id_pam)
    {
        ...
        $tampilkan = DB::table('tb_pam_msp')
                    ...
                    ->join('tb_pr_msp','tb_pr_msp.no','=','tb_pam_msp.no_pr')
                    ->join('tb_pr_product_msp', 'tb_pr_product_msp.id_pam','=','tb_pam_msp.id_pam')
                    ->select('tb_pam_msp.id_pam','tb_pam_msp.nik_admin','tb_pam_msp.date_handover','users.name', 'tb_pam_msp.to_agen', 'tb_pr_product_msp.nominal','tb_pam_msp.status', 'tb_pr_msp.date', 'tb_pr_msp.no_pr','file')
                    ->where('tb_pam_msp.id_pam',$id_pam)
                    ->first();

        $produks = DB::table('tb_pam_msp')
            ->join('tb_pr_product_msp','tb_pr_product_msp.id_pam','=','tb_pam_msp.id_pam')
            ->select('tb_pr_product_msp.id_product','tb_pr_product_msp.name_product','tb_pr_product_msp.qty','tb_pr_product_msp.id_pam','tb_pr_product_msp.description', 'tb_pr_product_msp.msp_code', 'tb_pr_product_msp.nominal', 'tb_pr_product_msp.total_nominal')
            ->where('tb_pam_msp.id_pam',$id_pam)
            ->get();

        $total_produk = DB::table('tb_pam_msp')
            ->join('tb_pr_product_msp','tb_pr_product_msp.id_pam','=','tb_pam_msp.id_pam')
            ->select('tb_pr_product_msp.id_product','tb_pr_product_msp.name_product','tb_pr_product_msp.qty','tb_pr_product_msp.id_pam','tb_pr_product_msp.description')
            ->where('tb_pam_msp.id_pam',$id_pam)
            ->count('name_product');
...
//Progress PR Asset
    ...
    public function getDropdownId(Request $request)
    {

        return array(DB::table('inventory_produk_msp')
                ->select('id_product','nama','unit')
                ->where('kode_barang',$request->product)
                ->get(),$request->product);
    }

    /*public function response($id_pam)
    {

        $file = DB::table('tb_pam_msp')
                ->select('file')
                ->where('id_pam', $id_pam)
                ->first();

        return view('admin_msp.pdf_quotation', compact('file'));
    }*/
    ...
    public function downloadPDF()
    {
        ...
        $datas = DB::table('tb_pam_msp')
            ...
            ->join('tb_pr_msp','tb_pr_msp.no','=','tb_pam_msp.no_pr')
            ->select('tb_pam_msp.id_pam','tb_pr_msp.date','tb_pr_msp.no_pr','tb_pam_msp.to_agen','tb_pam_msp.status','users.name','tb_pam_msp.subject','users.name','tb_pam_msp.subject', 'tb_pr_msp.no', 'tb_pr_msp.date', 'tb_pam_msp.attention', 'tb_pam_msp.project', 'tb_pam_msp.project_id', 'address', 'telp', 'fax', 'email')
            ->where('nik_admin', $nik)
            ->get();
    ...
    public function downloadPDF2($id_pam)
    {
        ...
        $datas = DB::table('tb_pam_msp')
            ->join('users','users.nik','=','tb_pam_msp.personel')
            ->join('tb_pr_msp','tb_pr_msp.no','=','tb_pam_msp.no_pr')
            ->select('tb_pam_msp.id_pam','tb_pam_msp.date_handover','tb_pr_msp.no_pr','tb_pam_msp.to_agen','tb_pam_msp.status','users.name','tb_pam_msp.subject', 'users.id_division', 'users.id_position','tb_pr_msp.date', 'tb_pam_msp.attention', 'tb_pam_msp.project', 'tb_pam_msp.project_id', 'tb_pam_msp.address', 'tb_pam_msp.telp', 'tb_pam_msp.fax', 'tb_pam_msp.email', 'tb_pam_msp.ppn', 'terms')
            ->where('nik_admin', $nik)
            ->where('tb_pam_msp.id_pam', $id_pam)
            ->first();
