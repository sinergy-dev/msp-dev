...
class PAMController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('DVG/pam/pam',compact('notif','notifOpen','notifsd','notiftp','notifClaim','pam','produks','pams','sum','id_pam','count_product','total_amount','no_pr','total_amount', 'project_id'));
    }
    ...
    public function detail_pam($id_pam)
    {
        ...
        $tampilkan = DB::table('dvg_pam')
                    ...
                    ->join('dvg_pr_product','dvg_pr_product.id_pam','=','dvg_pam.id_pam')
                    ->select('dvg_pam.id_pam','tb_pr.no_pr','dvg_pam.nik_admin','dvg_pam.date','users.name', 'dvg_pam.to_agen', 'dvg_pr_product.nominal','dvg_pam.ket_pr','dvg_pam.status')
        ...
        return view('DVG/pam/detail_pam',compact('count_pam','total_produk','detail_pam', 'notif', 'notifsd', 'notifOpen', 'notiftp','notifClaim', 'nomor', 'tampilkan','produks','total_amount', 'produks_cus'));
    }
...
//Progress PR Asset
    ...
    public function downloadPDF()
    {
        ...
        $datas = DB::table('dvg_pam')
            ->join('users','users.nik','=','dvg_pam.personel')
            ->join('tb_pr','tb_pr.no','=','dvg_pam.no_pr')
            ->select('dvg_pam.id_pam','dvg_pam.date_handover','tb_pr.no_pr','dvg_pam.ket_pr','dvg_pam.note_pr','dvg_pam.to_agen','dvg_pam.status','users.name','dvg_pam.subject','users.name')
            ->where('nik_admin', $nik)
            ->get();
